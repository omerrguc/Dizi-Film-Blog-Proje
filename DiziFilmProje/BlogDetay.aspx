<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="BlogDetay.aspx.cs" Inherits="DiziFilmProje.BlogDetay" %>
                    ...
                    <div class="single-grid">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                ...
                                <img src="<%# Eval("BLOGGORSEL") %>" alt="" style="height: 300px; width: 730px; margin-bottom: 20px;" />
